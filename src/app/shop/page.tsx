  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
      ...
      <div className="text-center bg-gray-100 p-6">
        ...
        <h4 className="text-lg text-gray-800 font-bold mt-6">
          $10 <span className="text-gray-400 ml-2 font-medium line-through">$15</span>
        </h4>
        <button
          type="button"
    ...
    <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
      ...
      <div className="text-center bg-gray-100 p-6">
        ...
        <h4 className="text-lg text-gray-800 font-bold mt-6">
          $12 <span className="text-gray-400 ml-2 font-medium line-through">$17</span>
        </h4>
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 mt-6 px-6 py-3 bg-yellow-400 text-base text-gray-800 font-semibold rounded-xl"
    ...
    <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
      ...
      <div className="text-center bg-gray-100 p-6">
        ...
        <h4 className="text-lg text-gray-800 font-bold mt-6">
          $14 <span className="text-gray-400 ml-2 font-medium line-through">$19</span>
        </h4>
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 mt-6 px-6 py-3 bg-yellow-400 text-base text-gray-800 font-semibold rounded-xl"
    ...
    <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
      ...
      <div className="text-center bg-gray-100 p-6">
        ...
        <h4 className="text-lg text-gray-800 font-bold mt-6">
          $15 <span className="text-gray-400 ml-2 font-medium line-through">$20</span>
        </h4>
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 mt-6 px-6 py-3 bg-yellow-400 text-base text-gray-800 font-semibold rounded-xl"
    ...
    <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
      ...
      <div className="text-center bg-gray-100 p-6">
        ...
        <h4 className="text-lg text-gray-800 font-bold mt-6">
          $11 <span className="text-gray-400 ml-2 font-medium line-through">$16</span>
        </h4>
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 mt-6 px-6 py-3 bg-yellow-400 text-base text-gray-800 font-semibold rounded-xl"
    ...
    <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
      ...
      <div className="text-center bg-gray-100 p-6">
        ...
        <h4 className="text-lg text-gray-800 font-bold mt-6">
          $13 <span className="text-gray-400 ml-2 font-medium line-through">$18</span>
        </h4>
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 mt-6 px-6 py-3 bg-yellow-400 text-base text-gray-800 font-semibold rounded-xl"
