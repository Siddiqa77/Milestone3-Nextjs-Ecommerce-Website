    ...
    <div>
        ...
        <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 ">
            <div className="text-center px-6">
                ...
                <p className="text-lg text-[#000] mt-4">Have some big idea or brand to develop and need help?</p>
            </div>
            ...
            <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
                ...
                <div className="bg-[#FFF3E3] rounded-lg p-6 h-full max-lg:order-1">
                    <h2 className="text-xl text-[#000]">Contact Information</h2>
                    <p className="text-sm text-gray-600 mt-4">Have some big idea or brand to develop and need help?</p>
                ...
                <div className="p-4 lg:col-span-2">
                    <form>
                        ...
                        <button type="button"
                            className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide  bg-[#B88E2F] poppins text-[#fff] font-medium  hover:bg-amber-700">
