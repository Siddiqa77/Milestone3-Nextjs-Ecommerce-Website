...
const Contact = () => {
  return (
    <div>
        <img className="w-[1440px] h-[316px] wrapper" src="/contactpic1.png" />

        {/* contact form */}

        <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 ">
            <div className="text-center px-6">
                <h2 className="text-[#000] text-4xl font-bold family">Contact Us</h2>
                <p className="text-lg text-[#000] mt-4 poppins">Have some big idea or brand to develop and need help?</p>
            </div>

            <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">

                <div className="bg-[#FFF3E3] rounded-lg p-6 h-full max-lg:order-1">
                    <h2 className="text-xl text-[#000] poppins">Contact Information</h2>
                    <p className="text-sm text-gray-600 mt-4 poppins">Have some big idea or brand to develop and need help?</p>
                    ...
                    <ul className="mt-16 space-y-8">
                        <li className="flex items-center">
                            ...
                            <a href="#" className=" text-sm text-gray-600 ml-4">
                                info@example.com
                            </a>
                        </li>
                        <li className="flex items-center">
                ...
                <div className="p-4 lg:col-span-2">
                    <form>
                        <div className="grid sm:grid-cols-2 gap-8">
                            ...
                            <div className="relative flex items-center sm:col-span-2">
                                <textarea placeholder="Write Message"
                                    className="px-2 pt-3 bg-[#fff]  w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none"></textarea>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2"
                                    viewBox="0 0 682.667 682.667">
                                    <defs>
                                        <clipPath id="a" clipPathUnits="userSpaceOnUse">
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="flex max-lg:flex-col gap-6 mt-4">
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-gray-600 ml-4">General Inquiry</p>
                                    </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-gray-600 ml-4">Technical Support</p>
                                    </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-gray-600 ml-4">Website Feedback</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="button"
                            className="mt-12 poppins flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide  bg-[#B88E2F] poppins text-[#fff] font-medium  hover:bg-amber-700">
