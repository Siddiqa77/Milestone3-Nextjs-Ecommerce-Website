...
const Bottombanner = () => {
  return (
    <div>
        <div className="mt-40">
      <div className="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-[#FFF3E3]">
        <div className="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
          <h2 className="text-[#B88E2F] lg:text-5xl text-3xl font-bold lg:leading-[56px]">Elevate Your Experience with Modern Elegance</h2>
          <p className="text-[#B88E2F] mt-6 text-base leading-relaxed">Laboris qui Lorem ad tempor ut reprehenderit. Nostrud anim nulla officia ea sit deserunt. Eu eu quis anim aute Laboris qui Lorem ad tempor ut reprehenderit.</p>
          <button type='button'
            className=" bg-[#B88E2F] mt-12 transition-all px-6 py-2.5 poppins text-[#fff] text-sm font-medium rounded-sm hover:bg-amber-700  hover:font-bold">Get Started</button>
        </div>
